...
const SlidingShutter: React.FC<{
    ...
    const glassStyle: React.CSSProperties = { ...(!isMesh && glassStyles[config.glassType]) };

    if (config.glassTexture && !isMesh) {
        glassStyle.backgroundImage = `url(${config.glassTexture})`;
