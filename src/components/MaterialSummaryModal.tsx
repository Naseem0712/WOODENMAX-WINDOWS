...
import type { BOM, QuotationItem, QuotationSettings, ProfileDimensions } from '../types';
...
export const MaterialSummaryModal: React.FC<MaterialSummaryModalProps> = ({ isOpen, onClose, bom, items, settings }) => {
    ...
    const handleExportPdf = () => {
        ...
        try {
            ...
            // 'avoid-all' with html2pdf often inserts a blank first page; css + legacy is enough for BOM
